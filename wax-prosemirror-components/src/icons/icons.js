...
export default {
  ...
  transformCase: ({ className }) => (
    <Svg className={className}
        enableBackground="new 0 0 16 16" viewBox="0 0 28 28" fill="none">
  ...
  lowerCaseTransform: ({ className }) => (
    <Svg className={className} viewBox="0 0 28.08 28.08" enableBackground="new 0 0 28.08 28.08" fill="none">
